...
const ImageCropper = (_ref, ref) => {
  ...
  const path = (0, _reactNativeReanimated.useDerivedValue)(() => {
    ...
    p.close();
    return p;
  }, [TOP_LEFT.x.value, TOP_LEFT.y.value, BOTTOM_LEFT.x.value, BOTTOM_LEFT.y.value, BOTTOM_RIGHT.x.value, BOTTOM_RIGHT.y.value, TOP_RIGHT.x.value, TOP_RIGHT.y.value]);
  ...
  return /*#__PURE__*/React.createElement(_reactNativeGestureHandler.GestureHandlerRootView, {
    ...
    fadeDuration: 0
  }), imageUrl && /*#__PURE__*/React.createElement(_reactNativeSkia.Canvas, {
    style: dynamicStyles({
      viewHeight
    }).canvas
  }, /*#__PURE__*/React.createElement(_reactNativeSkia.Path, {
    path: path,
    color: color
